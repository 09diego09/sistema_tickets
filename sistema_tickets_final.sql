...
CREATE TABLE `respuestas` (
  ...
  `tipo` enum('publico','nota_interna') DEFAULT 'publico',
  `fecha` datetime DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `ticket_id` (`ticket_id`),
  KEY `usuario_id` (`usuario_id`),
...
-- Dump completed on 2025-12-30 15:14:53
